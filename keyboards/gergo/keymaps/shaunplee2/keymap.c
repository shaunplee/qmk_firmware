 ...
 *
 * ,-------------------------------------------.                         ,-------------------------------------------.
 * | NMPD/Tb|   Q  |   W  |   E  |   R  |   T  |                         |   Y  |   U  |   I  |   O  |   P  |  [     |
 * |--------+------+------+------+------+------|------.           .------|------+------+------+------+------+--------|
 * | Ctrl   |   A  |   S  |  D   |   F  |   G  | Esc  |           | Ins  |   H  |   J  |   K  |   L  | ;  : | '/RCtL |
 * |--------+------+------+------+------+------|------|           |------|------+------+------+------+------+--------|
 * | LShift |   Z  |   X  |   C  |   V  |   B  | Esc  |           | Del  |   N  |   M  | ,  < | . >  | /  ? |\ / RSft|
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *                    .----------.   .---------.                                 .-----------.   .-----.
 *                    | SYMB/App |   |NUMB/Spc |                                 | NUMB/Entr |   |SYMB/PgDn |
 *                    '----------'   '---------'                                 `-----------.   '-----'
 *                                        ,-------.                      ,-------.
 *                                        | LGUI  |                      |NUMPAD |
 *                                 ,------|-------|                      |-------|------.
...
[BASE] = LAYOUT_gergo(
    ...
    KC_LCTL,                KC_A,  KC_S,   KC_D,   KC_F, KC_G, KC_ESC,                           KC_INS,   KC_H,    KC_J, KC_K, KC_L,   KC_SCLN, RCTL_T(KC_QUOT),
    KC_LSFT,                KC_Z,  KC_X,   KC_C,   KC_V, KC_B, KC_ESC, MOD_LGUI,    TG(NUMPAD),  KC_DEL,   KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, RSFT_T(KC_PIPE),
                        LT(SYMB, KC_APP), LT(NUMB, KC_SPC), KC_LALT, TO(MOUSE),        KC_PGUP, KC_BSPC,    LT(NUMB, KC_ENT), LT(SYMB, KC_PGDN)
    ),
