...
[BASE] = LAYOUT_gergo(
    ...
    KC_LSFT,                KC_Z,  KC_X,   KC_C,   KC_V, KC_B, KC_ESC, KC_APP,       TG(NUMPAD), KC_DEL,   KC_N,    KC_M, KC_COMM, KC_DOT, KC_SLSH, RSFT_T(KC_PIPE),
                           KC_LGUI, OSL(SYMB), LT(NUMB, KC_SPC), KC_LALT,               KC_BSPC,    LT(NUMB, KC_ENT), OSL(SYMB), KC_RCTL
    ),
...
[DVORAK] = LAYOUT_gergo(
    ...
    KC_LSFT,            KC_SCLN,KC_Q,   KC_J,   KC_K, KC_X, KC_ESC, KC_APP,       TG(NUMPAD), KC_DEL,   KC_B,  KC_M, KC_W, KC_V, KC_Z, RSFT_T(KC_PIPE),
                        KC_LGUI, OSL(SYMB), LT(NUMB, KC_SPC), KC_LALT,               KC_BSPC,    LT(NUMB, KC_ENT), OSL(SYMB), KC_RCTL
    ),
 ...
 */
[NUMPAD] = LAYOUT_gergo(
    KC_TRNS, KC_NUM, KC_P7,   KC_P8,   KC_P9,   KC_PMNS,                                             KC_NUM, KC_P7,   KC_P8,   KC_P9,   KC_PMNS, KC_PSLS,
